...
export default function InternationalCoursesPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* 히어로 섹션 */}
      <section className="pt-36 pb-16 px-4 bg-gradient-to-b from-sky-50 to-white">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-[#86868b] text-lg mb-4">International School & Study Abroad</p>
          <h1 className="text-4xl md:text-6xl font-black text-[#1d1d1f] tracking-tight">
            <span className="bg-gradient-to-r from-sky-600 via-blue-500 to-indigo-400 bg-clip-text text-transparent">국제학교/유학생</span> 강의
          </h1>
          <p className="text-xl text-[#86868b] mt-6">
            국제학교 재학생과 해외 유학생을 위한 맞춤형 영어 수업
          </p>
        </div>
      </section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-24">
              {courses.map((course) => (
                ...
                >
                  ...
                  {/* 정보 */}
                  <div className="p-5">
                    <h3 className="text-xl font-bold text-[#1d1d1f] mb-4 group-hover:text-sky-600 transition-colors line-clamp-2">
                      {course.title}
                    </h3>
